...
DEFAULT_RESULTS_DIR = ROOT / "results" / "estimated_full35_frac70"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--summary-csv",
        type=Path,
        default=DEFAULT_RESULTS_DIR / "estimated_full35_circuit_summary.csv",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=DEFAULT_RESULTS_DIR / "fig_dominant_group_positions.png",
    )
