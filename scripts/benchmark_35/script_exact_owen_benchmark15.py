...
---------------------
1) Reads `data/benchmark_35_from_pool_summary.csv` and extracts the 15 circuits with
   `selection_mode == "exact"`.
2) Loads `data/benchmark_35_from_pool.pkl` and reconstructs a Qiskit circuit for each
...
OUTPUT_DIR = ROOT / "results" / "exact_owen_15"
