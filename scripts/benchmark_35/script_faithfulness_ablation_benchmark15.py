...
Outputs
-------
Written to results/faithfulness_ablation_15/ by default:
...
Optional:
    python script_faithfulness_ablation_benchmark15.py \
        --exact-results-json results/exact_owen_15/exact_owen_results.json
...
ABLATION_OUTPUT_DIR = ROOT / "results" / "faithfulness_ablation_15"
