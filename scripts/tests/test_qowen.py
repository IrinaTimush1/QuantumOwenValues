...
# Install the package in editable mode with `pip install -e .` to make
# qshaptools importable. The sys.path insertion below is a fallback for
# ad-hoc runs from a source checkout.
ROOT = Path(__file__).resolve().parents[2]
QSHAPTOOLS_SRC = ROOT / "qshaptools" / "src"
QSHAPTOOLS_PKG = QSHAPTOOLS_SRC / "qshaptools"
