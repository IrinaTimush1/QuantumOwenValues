...
Typical usage from the OVQX repo root:
    python scripts/qnn/reproduce_qnn_svqx.py --mode fig13 --use-paper-theta --n-jobs 5
    python scripts/qnn/reproduce_qnn_svqx.py --mode fig14 --use-paper-theta --n-jobs 5
    python scripts/qnn/reproduce_qnn_svqx.py --mode both  --use-paper-theta --n-jobs 5
...
def infer_repo_root() -> Path:
    ...
    candidates = [here.parent, here.parent.parent, here.parents[2], Path.cwd()]
    for c in candidates:
